...
const ShopProductCard = ({ item }: ShopProductCardProps) => {
    ...
    >
      ...
      <div className="new-arrival-card__inner">
        <div className="new-arrival-card__media">
          {discount > 0 && (
            <span className="new-arrival-card__badge">-{discount}%</span>
          )}
        ...
        <div className="new-arrival-card__content">
          <div className="mb-2 flex items-center gap-2">
            ...
            <p className="text-xs text-cc-muted">({item.reviews})</p>
          </div>

          <h3 className="mb-1.5 line-clamp-2 text-sm font-semibold leading-snug text-cc-text">
            {item.title}
          </h3>

          <div className="flex flex-wrap items-center gap-2">
            <span className="text-base font-semibold text-cc-accent">
              ₹{item.discountedPrice.toLocaleString("en-IN")}
            </span>
            {discount > 0 && (
              <span className="text-sm text-cc-muted line-through">
